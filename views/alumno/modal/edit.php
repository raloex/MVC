...
<div class="modal-body">
    ...
    <form id="form-edit" method="POST">
        <p>
            ...
            <input type="text" name="matricula"  value="<?=$this->alumno->matricula?>" readonly required>
        </p>
        <p>
        ...
        <p>
            ...
            <input type="text" name="apellidos"  value="<?=$this->alumno->apellidos?>" required>
        </p>
    </form>
</div>
...
<script>
    $(document).ready(function() {
        $('body').on('click', '#edit', function() {
            ...
            xhttp.open("POST", "<?=constant('URL').'alumno/actualizarAlumno/'?>", true);
